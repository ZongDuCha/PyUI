<template>
  <div style="padding:10px;line-height: 25px;">
    <div style="width:45vw;float:left">
      ...
      <h3>页面加载input获取焦点</h3>
      <div style="width:200px"><py-input :autofocus="true" /></div>
      ...
      <div style="width:300px">
        <py-input> <i class="iconfont  icon-coordinates" slot="before"></i> </py-input>
      </div>

      <div style="width:300px">
        <py-input> <i class="iconfont  icon-coordinates" slot="after"></i> </py-input>
      </div>
      ...
      <div style="width:300px">
        <py-input> <span slot="before">前置</span> <span slot="after">后置</span> </py-input>
      </div>

      <h3>large(大) small（小）</h3>
      <div style="width:300px">
        <py-input size="large" placeholder="large">
          <span slot="before">前置内容</span> <span slot="after">后置内容</span>
        </py-input>
        <py-input size="small" placeholder="small">
          <span slot="before">1231231</span> <span slot="after">1qweqew</span>
        </py-input>
      </div>
    </div>
    ...
    <div style="width:45vw;float:left">
      ...
      <div>
        ...
        <py-input type="textarea" auto-height />
      </div>
    </div>
  </div>
</template>
